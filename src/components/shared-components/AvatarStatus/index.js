...
const renderAvatar = props => {
	return <Avatar {...props} className={`ant-avatar-${props.type}`} onClick={props.onNameClick}>{props.text}</Avatar>;
}
...
export const AvatarStatus = props => {
	...
	return (
		<div className="avatar-status d-flex align-items-center">
			{renderAvatar({icon, src, type, size, shape, gap, text, onNameClick })}
			<div className="ml-2">
				<div>
					{
						onNameClick ? 
